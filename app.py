...
def ask_for_username(chat_id):
    ...
    try:
        bot.send_photo(
            chat_id,
            "AgACAgUAAxkBAANkaU64bQwbBTFmEtyMAAEiYHzC3LQiAALHDGsb-bhwVmmDBlmoL3vhAQADAgADeAADNgQ",
            caption=text,
            parse_mode="Markdown"
        )
    except Exception as e:
...
def handle_text(message):
    ...
    if user_state.get(chat_id) == "WAITING_USERNAME":
        ...
        reply_text = (
            ...
            "👉 [BÍCH NGỌC CSKH U888](https://t.me/bichngocmaster)\n\n"
        )
        ...
        try:
            bot.send_photo(
                chat_id,
                "AgACAgUAAxkBAANMaU63wtLIxDW0P9ri8UNaEEnjzOQAAsUMaxv5uHBWlZ81J0AhhT8BAAMCAAN4AAM2BA",  # 👈 THAY bằng file_id ảnh thật (AgACAgU....)
                caption=reply_text,
                parse_mode="Markdown"
            )
        except Exception as e:
